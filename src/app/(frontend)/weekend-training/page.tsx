  ...
  return (
    <>
      <section className="relative isolate overflow-hidden py-16 text-white sm:py-20">
        <Image
          src="/images/training/weekend-training.png"
          alt=""
          fill
          priority
          sizes="100vw"
        ...
        <Container>
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-slate-200">
              Keep your weekdays free. Our weekend batches cover the same
              curriculum at a pace built for working professionals, meeting

    ...
    <>
      <section className="bg-slate-950 py-16 text-white">
        <Container>
          ...
          <h1 className="mt-2 max-w-2xl text-3xl font-bold sm:text-4xl">Job Assistance</h1>
          <p className="mt-4 max-w-2xl text-slate-300">
            Our commitment to your career doesn&apos;t end when the course does. Our placement support team works
            with every graduate on the fundamentals that actually move the needle in a job search.
          </p>
        </Container>
      </section>
      ...
      <Container className="py-16">
        <div className="grid gap-6 sm:grid-cols-2">
          {benefits.map((b) => (
            <div key={b.title} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h2 className="mt-4 font-semibold text-slate-900">{b.title}</h2>
        ...
        <p className="mt-10 max-w-3xl text-sm text-slate-500">
          We offer wide-ranging support and resources to every graduate, but please note that employment is not
          guaranteed. Your outcomes depend on your own effort, the market, and how you apply what you&apos;ve
          learned.
        </p>
